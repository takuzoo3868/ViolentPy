...
banner = r"""{}{}
  __   _  _    _  _  _  _    ____   ___  ____   __   ____  ____  ____  ____ 
 /  \ / )( \  ( \/ )( \/ )  / ___) / __)(  _ \ / _\ (  _ \(  _ \(  __)(  _ \
(  O )) __ (  / \/ \ )  /   \___ \( (__  )   //    \ ) __/ ) __/ ) _)  )   /
 \__/ \_)(_/  \_)(_/(__/    (____/ \___)(__\_)\_/\_/(__)  (__)  (____)(__\_)
...
def main():
    print(banner)
    parser = argparse.ArgumentParser(usage="%(prog)s -p <firefox profile path>")
    parser.add_argument("-p", dest="path_name", type=str, help="specify firefox profile path")
